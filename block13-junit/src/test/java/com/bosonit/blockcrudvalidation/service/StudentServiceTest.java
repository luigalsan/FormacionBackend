...
class StudentServiceTest {
    ...
    @Test
     void testAddStudent(){
        ...
        assertEquals(1, student.getPersona().getIdPersona());
    ...
    @Test
     void testGetStudentById(){
        ...
        assertEquals(student_id, result.getIdStudent());
    ...
    @Test
     void testUpdateStudent() {
        ...
        studentInicial.setIdStudent(idStudent);
    ...
    @Test
     void testUpdateStudentNotFound() {
        ...
        Integer idStudent = 1; // El ID que deseamos actualizar
        StudentInputDto inputDTO = new StudentInputDto();
        inputDTO.setIdStudent(idStudent);
    ...
    @Test
     void testDeleteStudentByIdNotFound(){
        ...
        StudentInputDto inputDTO = new StudentInputDto();
        inputDTO.setIdPersona(studentId);
    ...
    @Test
     void testDesasignarAsignaturasEstudiante() {
        ...
        Student student = new Student();
        student.setIdStudent(idEstudiante);
        student.setAsignatura(new HashSet<>());

        // Crear asignaturas simuladas
        Asignatura asignatura1 = new Asignatura();
        asignatura1.setIdAsignatura(101);
        Asignatura asignatura2 = new Asignatura();
        asignatura2.setIdAsignatura(102);
