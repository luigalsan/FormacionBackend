...
public class Controller {
    ...
    @PostMapping("/useradd")
    public Persona addUser(@RequestBody Persona persona) { //Spring recibe un objeto JSON y Spring Boot lo deserializa en un objeto Persona que recibe por parámetro Persona persona, incrementa la edad en uno y luego devuelve el objeto Persona modificado que SB serializa automáticamente como JSON para la respuesta
